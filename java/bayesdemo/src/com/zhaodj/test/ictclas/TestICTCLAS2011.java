package com.zhaodj.test.ictclas;
...
public class TestICTCLAS2011 {
	...
	public static void Split(String sInput) {
		try {
			...
			String argu = "/home/zhaodj/javalib/ictclas/2012";
			...
			// 导入用户词典前
			byte nativeBytes[] = testICTCLAS2011.ICTCLAS_ParagraphProcess(
					sInput.getBytes("GB2312"), 1);
			...
			// 导入用户词典
			String sUserDict = "/home/zhaodj/文档/temp/ictclas/userdic.txt";
			int nCount = testICTCLAS2011.ICTCLAS_ImportUserDict(sUserDict
					.getBytes("GB2312"));
			testICTCLAS2011.ICTCLAS_SaveTheUsrDic();// 保存用户词典
			System.out.println("导入个用户词： " + nCount);

			nativeBytes = testICTCLAS2011.ICTCLAS_ParagraphProcess(
					sInput.getBytes("GB2312"), 1);
			...
			// 文件分词
			String argu1 = "/home/zhaodj/文档/temp/ictclas/testGBK.txt";
			String argu2 = "/home/zhaodj/文档/temp/ictclas/testGBK_result.txt";
			File file=new File(argu1);
			if(file.exists()){
				System.out.println("文件存在");
			}
			testICTCLAS2011.ICTCLAS_FileProcess(argu1.getBytes("UTF-8"),
					argu2.getBytes("UTF-8"), 1);

			// 分词高级接口
			nativeBytes = testICTCLAS2011.nativeProcAPara(sInput
					.getBytes("GB2312"));

			int nativeElementSize = testICTCLAS2011.ICTCLAS_GetElemLength(0);// size
																				// of
																				// result_t
																				// in
																				// native
			...
			// 关键词提取
			int nCountKey = testICTCLAS2011.ICTCLAS_KeyWord(nativeBytesTmp,
					nElement);
			...
			for (int i = 0; i < resultArr.length; i++) {
				System.out.println("start=" + resultArr[i].start + ",length="
						+ resultArr[i].length + "pos=" + resultArr[i].posId
						+ "word=" + resultArr[i].wordId + "  weight="
						+ resultArr[i].weight);
			}
	...
	public static void SplitUTF8() {
		try {
			...
			String argu = "/home/zhaodj/javalib/ictclas/2012";
			if (testICTCLAS2011.ICTCLAS_Init(argu.getBytes("GB2312"), 1) == false) {// UTF8切分
				System.out.println("Init Fail!");
				return;
			}
			String argu1 = "/home/zhaodj/文档/temp/ictclas/testUTF.txt";
			String argu2 = "/home/zhaodj/文档/temp/ictclas/testUTF_result.txt";
			testICTCLAS2011.ICTCLAS_FileProcess(argu1.getBytes("GB2312"),
					argu2.getBytes("GB2312"), 1);
	...
	public static void SplitBIG5() {
		try {
			...
			String argu = "/home/zhaodj/javalib/ictclas/2012";
			if (testICTCLAS2011.ICTCLAS_Init(argu.getBytes("GB2312"), 2) == false) {// UTF8切分
				System.out.println("Init Fail!");
				return;
			}
			String argu1 = "/home/zhaodj/文档/temp/ictclas/testBIG.txt";
			String argu2 = "/home/zhaodj/文档/temp/ictclas/testBIG_result.txt";
			testICTCLAS2011.ICTCLAS_FileProcess(argu1.getBytes("GB2312"),
					argu2.getBytes("GB2312"), 1);
