...
public class JacksonDemo {
	...
	public static void main(String[] args) throws JsonParseException, JsonMappingException, IOException {
		...
		json = "{\"error\":\"invalid_access_token\",\"error_code\":21332,\"request\":\"/2/friendships/friends/bilateral.json\",\"arr\":[1,2,3,4]}";
		node = mapper.readValue(json, JsonNode.class);
		users = node.path("users");
		System.out.println(users == null);
		System.out.println(users.isArray());
		System.out.println(users.isNull());
		JsonNode arr = node.path("arr");
